...
def classifier_execute(idx_list):
    ...
    for idx in idx_list:
        ...
        output_file = open(f"4o-mini_with_reviewer\\{idx+1}.txt", "w+", encoding="utf-8")
...
def detailed_citation_execute(idx_list):
    ...
    for idx in idx_list:
        data_file = open(f"4o-mini_with_reviewer\\{idx+1}.txt", "r", encoding="utf-8")
        output_file = open(f"4o-mini_with_reviewer\\_{idx+1}.txt", "w+", encoding="utf-8")
